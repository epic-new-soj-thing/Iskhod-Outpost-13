GLOBAL_LIST_EMPTY(marked_obelisks)

/obj/machinery/power/marked_obelisk
	name = "The Marked One"
	desc = "A towering rectangle of light, shimmering with a normally invisible energy. You've heard rumours about the power that this holds."
	icon = 'icons/obj/marked_obelisk.dmi'
	icon_state = "idle"

	density = TRUE
	anchored = TRUE
	layer = 2.8
	scale = 1 // change to match roughly 5 to 7 tiles tall

	use_power = NO_POWER_USE // IDLE_POWER_USE maybe?
	//idle_power_usage = 30
